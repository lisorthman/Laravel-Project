...
<body>
    ...
    <div class="fullscreen-bg">
        ...
        <div class="image-container">
            <img src="<?php echo e(asset('images/homepage.jpg')); ?>" alt="Your Image">
        </div>
    </div>
</body>
</html>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lisorthman/Downloads/Travelly/resources/views/Pages/index.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
    <!-- Custom Logo (Centered with Offset) -->
    <div class="d-flex justify-content-center mb-6">
        <img src="<?php echo e(asset('images/custom-logo.png')); ?>" alt="Custom Logo" class="img-fluid" style="max-height: 100px; margin-left: 70px;">
    </div>
...
<?php endif; ?>
<?php /**PATH /Users/lisorthman/Downloads/Travelly/resources/views/auth/register.blade.php ENDPATH**/ ?>